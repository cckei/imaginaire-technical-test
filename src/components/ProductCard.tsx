  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="relative aspect-[3/4] overflow-hidden rounded bg-gray-100 border border-gray-200"
      >
        {image && (
          <Image
            src={image.url}
      ...
      <span className="flex grow min-h-[20px]"></span>
      {/* button */}
      <div>
        <Btn size="sm">View Product</Btn>
      </div>
    </article>
  );
}
